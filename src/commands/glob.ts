...
export async function globCommand(options: GlobOptions, cwd: string): Promise<void> {
  ...
  const agentsContent = `<!-- DO NOT EDIT — regenerated by \`memex glob\`. Local vault is a disposable projection; durable wiki writes belong in the global vault. -->
---
name: Project Wiki
...
> ⚠️ **Disposable projection.** This file and \`local/wiki/\` are regenerated on every \`memex glob\` and will silently overwrite local edits. Edit the corresponding pages in the global vault instead.
