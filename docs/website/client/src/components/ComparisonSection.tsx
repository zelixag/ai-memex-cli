...
function CellContent({ value }: { value: CellValue }) {
  ...
  return (
    <span className="text-xs text-foreground/60 font-[var(--font-body)]">
      {value}
    </span>
  );
}
